...
@section('content')
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form method="POST"
                action="{{ isset($citaEditar) ? route('admin.citas.update', $citaEditar->IDcita) : route('admin.citas.store') }}">
                @csrf
                @if (isset($citaEditar))
                    @method('PUT')
                @endif
                    ...
                    @forelse($citas as $cita)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.factura.excel', $cita->IDcita) }}" class="btn-warning3"
