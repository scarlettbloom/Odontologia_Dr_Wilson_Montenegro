...
<a href="{{ route('empleado.citas.index') }}">
    ...
    {{-- Buscador --}}
    <form method="GET" action="{{ route('empleado.inventario.index') }}" class="mb-4">
    ...
    <div class="flex gap-3 mb-6 flex-wrap">
        <a href="{{ route('empleado.inventario.create') }}"
            ...
            <tr class="hover:bg-slate-50">
                ...
                <td class="px-4 py-3 text-center">
                    <div class="flex justify-center gap-2">
                        <a href="{{ route('empleado.inventario.edit', $item->idinventario) }}"
